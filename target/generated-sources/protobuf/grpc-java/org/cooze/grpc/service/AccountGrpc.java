...
public final class AccountGrpc {
  ...
  public static final String SERVICE_NAME = "org.cooze.grpc.service.Account";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.cooze.grpc.entity.Account,
      org.cooze.grpc.entity.AccountResponse> METHOD_ADD_ACCOUNT =
      io.grpc.MethodDescriptor.<org.cooze.grpc.entity.Account, org.cooze.grpc.entity.AccountResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "org.cooze.grpc.service.Account", "addAccount"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.cooze.grpc.entity.Account.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.cooze.grpc.entity.AccountResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.cooze.grpc.entity.Account,
      org.cooze.grpc.entity.AccountResponse> METHOD_GET_ACCOUT_BY_NAME =
      io.grpc.MethodDescriptor.<org.cooze.grpc.entity.Account, org.cooze.grpc.entity.AccountResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "org.cooze.grpc.service.Account", "getAccoutByName"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.cooze.grpc.entity.Account.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.cooze.grpc.entity.AccountResponse.getDefaultInstance()))
  ...
  public static abstract class AccountImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addAccount(org.cooze.grpc.entity.Account request,
        io.grpc.stub.StreamObserver<org.cooze.grpc.entity.AccountResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_ADD_ACCOUNT, responseObserver);
    }

    /**
     */
    public void getAccoutByName(org.cooze.grpc.entity.Account request,
        io.grpc.stub.StreamObserver<org.cooze.grpc.entity.AccountResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_ACCOUT_BY_NAME, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.cooze.grpc.entity.Account,
                org.cooze.grpc.entity.AccountResponse>(
                  this, METHODID_ADD_ACCOUNT)))
          .addMethod(
            METHOD_GET_ACCOUT_BY_NAME,
            asyncUnaryCall(
              new MethodHandlers<
                org.cooze.grpc.entity.Account,
                org.cooze.grpc.entity.AccountResponse>(
                  this, METHODID_GET_ACCOUT_BY_NAME)))
          .build();
    }
  }
  ...
  public static final class AccountStub extends io.grpc.stub.AbstractStub<AccountStub> {
    ...
    public void getAccoutByName(org.cooze.grpc.entity.Account request,
        io.grpc.stub.StreamObserver<org.cooze.grpc.entity.AccountResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_ACCOUT_BY_NAME, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AccountBlockingStub extends io.grpc.stub.AbstractStub<AccountBlockingStub> {
    ...
    /**
     */
    public org.cooze.grpc.entity.AccountResponse addAccount(org.cooze.grpc.entity.Account request) {
    ...
    /**
     */
    public org.cooze.grpc.entity.AccountResponse getAccoutByName(org.cooze.grpc.entity.Account request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_ACCOUT_BY_NAME, getCallOptions(), request);
    }
  }
  ...
  public static final class AccountFutureStub extends io.grpc.stub.AbstractStub<AccountFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.cooze.grpc.entity.AccountResponse> addAccount(
        org.cooze.grpc.entity.Account request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.cooze.grpc.entity.AccountResponse> getAccoutByName(
        org.cooze.grpc.entity.Account request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_ACCOUT_BY_NAME, getCallOptions()), request);
    }
  }

  private static final int METHODID_ADD_ACCOUNT = 0;
  private static final int METHODID_GET_ACCOUT_BY_NAME = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_ACCOUNT:
          serviceImpl.addAccount((org.cooze.grpc.entity.Account) request,
              (io.grpc.stub.StreamObserver<org.cooze.grpc.entity.AccountResponse>) responseObserver);
          break;
        case METHODID_GET_ACCOUT_BY_NAME:
          serviceImpl.getAccoutByName((org.cooze.grpc.entity.Account) request,
              (io.grpc.stub.StreamObserver<org.cooze.grpc.entity.AccountResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (AccountGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_GET_ACCOUT_BY_NAME)
              .build();
        }
      }
    }
